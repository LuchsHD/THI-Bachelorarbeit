...
\setcitestyle{authoryear, open={(}, close={)}}	% hier statt erst vor \bibliography setzen,
												% sonst gilt der Stil nicht fuer Zitate in
												% frueheren Kapiteln (Bug in der Vorlage)
...
\ifoot{\footnotesize{Thomas Schneider}}
...
{
	(\textwidth ,0.4pt)
	\footnotesize{Thomas Schneider} \hfill \footnotesize{Bachelor Thesis}}
	{\footnotesize{Thomas Schneider} \hfill \footnotesize{Bachelor Thesis}}
	{\footnotesize{Thomas Schneider} \hfill \footnotesize{Bachelor Thesis}}
	(0pt ,0pt)
}
...
%--------------------------------------------------------------------------------
	...
	\pagenumbering{Roman} 					% Römische Nummerierung der Kapitel/Roman page numbering
	% TODO: Wert pruefen/anpassen, sobald das Vorspann (Titelseite bis
	% Inhaltsverzeichnis) final steht - muss an die Seitenzahl direkt NACH
	% dem letzten Vorspann-Roman-Seite anschliessen.
